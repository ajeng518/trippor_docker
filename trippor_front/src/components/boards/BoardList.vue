  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-10 mt-5 mb-5">
        <TheHeadingPage title="자유 게시판" subtitle="❤️‍🔥 여러분의 여행 후기를 들려주세요!! ❤️‍🔥"></TheHeadingPage>
          ...
          <div class="col-md-5 offset-5">
            <form class="d-flex">
              ...
              <div class="input-group input-group-sm ms-1">
                ...
                <button class="btn btn-secondary" type="button" @click="getArticleList">검색</button>
              </div>
            </form>
          </div>
        </div>
