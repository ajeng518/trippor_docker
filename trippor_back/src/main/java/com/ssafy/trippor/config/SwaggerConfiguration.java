package com.ssafy.trippor.config;
...
//	//http://localhost/vue/swagger-ui/index.html
    ...
    public Docket allApi() {
        return new Docket(DocumentationType.OAS_30)
            ...
            .apiInfo(allApiInfo())
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.ssafy.trippor"))
    ...
    public Docket userApi() {
        return new Docket(DocumentationType.OAS_30)
            ...
            .apiInfo(userApiInfo())
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.ssafy.trippor.member.controller"))
...
//            .select()
//            .apis(RequestHandlerSelectors.basePackage("com.ssafy.trippor.board.controller"))
...
//            .apiInfo(mapApiInfo())
//            .select()
//            .apis(RequestHandlerSelectors.basePackage("com.ssafy.trippor.map.controller"))
